...
def getcurrentsong():
    set_volume_command = 'tell application "Spotify" to get artist of current track & " - " & name of current track'
    apple_script_call = ['osascript', '-e', set_volume_command]
    song = subprocess.check_output(apple_script_call)
    return(song)
